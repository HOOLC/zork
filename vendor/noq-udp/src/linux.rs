...
pub(super) mod gso {
    ...
    pub(crate) fn max_gso_segments(socket: &impl AsRawFd) -> usize {
        // Android can advertise UDP_SEGMENT but then lose segmented sends.
        // Keep each QUIC datagram separate until the upstream retransmit fix
        // is in the pinned dependency: https://github.com/n0-computer/noq/pull/746
