...
impl MacWindow {
    pub fn open(
        ...
        gpui::observe_startup("gpui.window_begin");
        unsafe {
            ...
            // AppKit's initializer takes a bottom-left content origin. Keep the
            // requested top-left separately for final native frame placement.
            let window_rect = NSRect::new(
                NSPoint::new(top_left.x, top_left.y - bounds.size.height.as_f32() as f64),
                NSSize::new(
            ...
            gpui::observe_startup("gpui.window_screen_ready");
            ...
            gpui::observe_startup("gpui.native_window_ready");
            let () = msg_send![
                native_window,
            ...
            gpui::observe_startup("gpui.native_view_ready");
            ...
            gpui::observe_startup("gpui.window_state_ready");
            ...
            gpui::observe_startup("gpui.window_layer_ready");
            content_view.addSubview_(native_view.autorelease());
            native_window.makeFirstResponder_(native_view);

            gpui::observe_startup("gpui.window_responder_ready");
            ...
            // Complete placement and native chrome before showing the window,
            // so its first visible frame does not need an immediate correction.
            NSWindow::setFrameTopLeftPoint_(native_window, top_left);
            {
