...
pub(crate) struct MacKeyboardState {
    pub(crate) layout: MacKeyboardLayout,
    pub(crate) mapper: Rc<MacKeyboardMapper>,
}

impl MacKeyboardState {
    pub(crate) fn new() -> Self {
        gpui::observe_startup("gpui.keyboard_layout_begin");
        let layout = MacKeyboardLayout::new();
        let mapper = Rc::new(MacKeyboardMapper::new(layout.id()));
        gpui::observe_startup("gpui.keyboard_layout_ready");
        Self { layout, mapper }
    }
}
