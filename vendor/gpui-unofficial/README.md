...
## Local paint extension

Based on the unmodified crates.io `gpui-unofficial` 1.17.0-pre source.
`Window::with_scaled_paint_clip` scales a painted subtree and clips it to
