...
pub trait PlatformAtlas {
    /// Whether the renderer owning these resources composites retained scene
    /// layers and contour masks. Hosts must not infer this from the platform.
    fn supports_retained_paint(&self) -> bool {
        false
    }
