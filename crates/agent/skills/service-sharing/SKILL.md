...
Send the returned URL verbatim as a Markdown link with chat.post_message. The client extracts links into the Chat’s content list. An ordinary external page needs only a Markdown link. Static file deliverables use chat.post_file.
