...
class LocalScriptsTest {
    @Test fun explicitClickNativeCallbacksRecreationAndCancellation() {
        ...
        launch("const r = await android.startActivityForResult({action:'ing.zork.android.SCRIPT_RESULT',package:'${context.packageName}'}); console.log('answer=' + r.extras.answer);").use { scenario ->
            click("在本机执行")
