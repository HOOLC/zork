...
const icon=(n)=>`<span class="icon" style="--icon:url(/${common.has(n)?'design/reference-prototype/gui/glyphs/':'design/reference-prototype/svg/icons/'}${n}.svg)" aria-hidden="true"></span>`;
const av=(name,cls='')=>`<img class="${cls}" src="svg/avatars/${name}.svg" alt="">`;
